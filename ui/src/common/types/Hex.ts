import { CubeCoord, hexId } from './Coordinates';
 ...
 */
export function assignStandardHexes(boardRadius: number): { coord: CubeCoord; terrain: Terrain; rollNumber: number | null }[] {
...
/** Re-export for convenience so callers can build hex ids from coords. */
export { hexId };

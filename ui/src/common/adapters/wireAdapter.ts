...
import { Board, EdgeNode, HexNode, RoadObj, SettlementObj, VertexNode } from '../types/Board';
 ...
 * @param hexSize - pixel size used when the wire board omitted hex pixel data
 */

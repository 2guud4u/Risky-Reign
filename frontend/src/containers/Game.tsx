        ...
        switch (UiEvent) {
            case 'buildSettlement':
                if (checkHasPrice(player, SettlementPrice)) {
                    error = handleBuildSettlement(UiEventPayload as buildSettlementPayload, player, intersectMap, setSettlements, setIntersectMap, settlements);
                    if (error === undefined) {
